...
export default function MenuMobile({ isProfile, isBurgerConstructor, isFeed, isOrders }: MenuMobileType) {
      ...
      <div className={`${styles.menu} ${styles.menu_type_main}`}>
        ...
        <ul className={ styles.list }>
          <details className={ styles.listItem }>
            <summary className={ styles.dropdown }><ProfileIconLink isProfile={isProfile} isOrders={isOrders}/>
